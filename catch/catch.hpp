...
struct AutoReg : NonCopyable {
    ...
    #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2( TestNameClass, TestName, ClassName, Name, Tags, Signature, ... )    \
        ...
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION( ClassName, Name, Tags,... ) \
            INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_C_L_A_S_S_ ), INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ) , ClassName, Name, Tags, typename TS, __VA_ARGS__ )
    #else
        #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION( ClassName, Name, Tags,... ) \
            INTERNAL_CATCH_EXPAND_VARGS( INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_NO_REGISTRATION_2( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_C_L_A_S_S_ ), INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ) , ClassName, Name, Tags, typename TS, __VA_ARGS__ ) )
    #endif
...
#else
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE(Name, Tags, ...)\
        INTERNAL_CATCH_EXPAND_VARGS( INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE2( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ), INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_ ), Name, Tags, typename TS, __VA_ARGS__ ) )
#endif
...
#else
    #define INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD( ClassName, Name, Tags,... ) \
        INTERNAL_CATCH_EXPAND_VARGS( INTERNAL_CATCH_TEMPLATE_TEST_CASE_METHOD_2( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_C_L_A_S_S_ ), INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ) , ClassName, Name, Tags, typename TS, __VA_ARGS__ ) )
#endif
...
#else
    #define INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD( ClassName, Name, Tags, ... )\
        INTERNAL_CATCH_EXPAND_VARGS( INTERNAL_CATCH_TEMPLATE_PRODUCT_TEST_CASE_METHOD_2( INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_ ), INTERNAL_CATCH_UNIQUE_NAME( C_A_T_C_H_T_E_M_P_L_A_T_E_T_E_S_T_F_U_N_C_ ), ClassName, Name, Tags, typename TS,__VA_ARGS__ ) )
#endif
...
namespace Catch {
    namespace Detail {
        ...
        template<typename TS>
        std::string clrReferenceToString( TS^ ref ) {
            if (ref == nullptr)
...
#if defined(_MANAGED)
        template <typename TS>
        std::string stringify( TS^ e ) {
            return ::Catch::StringMaker<TS^>::convert(e);
        }
#endif
...
#if defined(_MANAGED)
    template <typename TS>
    struct StringMaker<TS^> {
        static std::string convert( TS^ ref ) {
...
namespace Catch {
    template<typename TS>
    struct StringMaker<std::optional<TS> > {
        static std::string convert(const std::optional<TS>& optional) {
            ReusableStringStream rss;
...
#pragma warning(disable:4312) // Converting int to TS* using reinterpret_cast (issue on x64 platform)
...
public:
    ...
    // inferring std::function<bool(TS const&)> is hard (but possible) and
    ...
    namespace Vector {
        ...
        struct EqualsMatcher : MatcherBase<std::vector<T, AllocMatch>> {
            ...
            bool match(std::vector<T, AllocMatch> const &v) const override {
                ...
                // to using !=. but could be specialised for, e.g. std::vector<TS, Alloc> etc
...
namespace Catch {
    ...
    template<typename TS>
    struct LazyStat : Option<TS> {
        LazyStat& operator=( TS const& _value ) {
            Option<TS>::operator=( _value );
            used = false;
            return *this;
        }
        void reset() {
...
namespace Catch {
    ...
    struct CumulativeReporterBase : IStreamingReporter {
        template<typename TS, typename ChildNodeT>
        struct Node {
            explicit Node( TS const& _value ) : value( _value ) {}
            virtual ~Node() {}
    ...
    class ReporterRegistrar {
        ...
        class ReporterFactory : public IReporterFactory {
            ...
            IStreamingReporterPtr create( ReporterConfig const& config ) const override {
                return std::unique_ptr<TS>( new TS( config ) );
            }
...
namespace Catch {
    ...
    public:
        ...
        public:
            ...
            template<typename TS>
            ScopedElement& writeAttribute( std::string const& name, TS const& attribute ) {
        ...
        template<typename TS>
        XmlWriter& writeAttribute( std::string const& name, TS const& attribute ) {
            ReusableStringStream rss;
            rss << attribute;
...
#pragma optimize("", on)
        ...
        template <typename TS>
        inline void deoptimize_value(TS&& x) {
            keep_memory(&x);
        }
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            template <typename TS>
            struct CompleteType { using type = TS; };
            template <>
            struct CompleteType<void> { struct type {}; };

            template <typename TS>
            using CompleteType_t = typename CompleteType<TS>::type;
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            template <typename TS>
            using Decay = typename std::decay<TS>::type;
            template <typename TS, typename U>
            struct is_related
                : std::is_same<Decay<TS>, Decay<U>> {};
            ...
            private:
                ...
                template <typename TS>
                BenchmarkFunction(model<TS>* c) : f(c) {}
...
namespace Catch {
    namespace Benchmark {
        namespace Detail {
            template <typename TS, bool Destruct>
            struct ObjectStorage
            {
                using TStorage = typename std::aligned_storage<sizeof(TS), std::alignment_of<TS>::value>::type;

                ObjectStorage() : data() {}

                ObjectStorage(const ObjectStorage& other)
                {
                    new(&data) TS(other.stored_object());
                }

                ObjectStorage(ObjectStorage&& other)
                {
                    new(&data) TS(std::move(other.stored_object()));
                }

                ~ObjectStorage() { destruct_on_exit<TS>(); }

                template <typename... Args>
                void construct(Args&&... args)
                {
                    new (&data) TS(std::forward<Args>(args)...);
                }
            ...
            private:
                ...
                TS& stored_object() {
                    return *static_cast<TS*>(static_cast<void*>(&data));
                }

                TS const& stored_object() const {
                    return *static_cast<TS*>(static_cast<void*>(&data));
                }
        ...
        template <typename TS>
        using storage_for = Detail::ObjectStorage<TS, true>;

        template <typename TS>
        using destructable_object = Detail::ObjectStorage<TS, false>;
    }
}
...
namespace detail {
    ...
    protected:
        ...
        ResultValueBase( ResultValueBase const &other ) : ResultBase( other ) {
            if( m_type == ResultBase::Ok )
                new( &m_value ) TS( other.m_value );
        }

        ResultValueBase( Type, TS const &value ) : ResultBase( Ok ) {
            new( &m_value ) TS( value );
        }
    ...
    class BasicResult : public ResultValueBase<TS> {
    public:
        template<typename U>
        explicit BasicResult( BasicResult<U> const &other )
        :   ResultValueBase<TS>( other.type() ),
    ...
    protected:
        ...
        :   ResultValueBase<TS>(type),
            m_errorMessage(message)
        {
            assert( m_type != ResultBase::Ok );
        }

        using ResultValueBase<TS>::ResultValueBase;
    ...
    template<typename TS>
    inline auto convertInto( std::string const &source, TS& target ) -> ParserResult {
        std::stringstream ss;
        ss << source;
        ss >> target;
        if( ss.fail() )
    ...
    template<typename TS>
    inline auto convertInto( std::string const &source, CLARA_CONFIG_OPTIONAL_TYPE<TS>& target ) -> ParserResult {
        TS temp;
    ...
    struct BoundValueRef : BoundValueRefBase {
        ...
        explicit BoundValueRef( TS &ref ) : m_ref( ref ) {}
    ...
    template<typename TS>
    struct BoundValueRef<std::vector<TS>> : BoundValueRefBase {
        std::vector<TS> &m_ref;

        explicit BoundValueRef( std::vector<TS> &ref ) : m_ref( ref ) {}
    ...
    public:
        template<typename TS>
        auto operator|( TS const &other ) const -> Parser;
    ...
    public:
        template<typename TS>
        ParserRefImpl( TS &ref, std::string const &hint )
        :   m_ref( std::make_shared<BoundValueRef<TS>>( ref ) ),
            m_hint( hint )
        {}
    ...
    public:
        ...
        template<typename TS>
        Opt( TS &ref, std::string const &hint ) : ParserRefImpl( ref, hint ) {}
    ...
    struct Parser : ParserBase {
        ...
        template<typename TS>
        auto operator+=( TS const &other ) -> Parser & { return operator|=( other ); }
        template<typename TS>
        auto operator+( TS const &other ) const -> Parser { return operator|( other ); }
    ...
    template<typename DerivedT>
    template<typename TS>
    auto ComposableParserImpl<DerivedT>::operator|( TS const &other ) const -> Parser {
...
// Older GCCs trigger -Wmissing-field-initializers for TS foo = {}
...
namespace Catch {
    template <typename TS>
    std::string to_string(TS const& t) {
...
template<typename TS>
std::string fpToString( TS value, int precision ) {
...
public:
    ...
    template<typename TS>
    friend TablePrinter& operator << (TablePrinter& tp, TS const& value) {
        tp.m_oss << value;
        return tp;
    }
